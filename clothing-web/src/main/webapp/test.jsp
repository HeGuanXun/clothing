...
<div class="col-xs-12">
    <form id="form_data" name="form_data" method="post" class="well form-horizontal clearfix">
        ...
        <table id="addorder" border=1 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none;background-color: #EEEEEE'>
            ...
            <tr style='height:13.1pt'>
                ...
                <td  colspan=4 rowspan=2 style='width:60px;border:solid 1.0pt;border-top:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
                ...
                <td width=65 colspan="2" rowspan=2 style='width:48.9pt;border:solid 1.0pt;border-top:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
                    <p style='text-align:center;width: 80px'><b><span style='font-size:9.0pt;font-family:宋体'>单位</span></b></p>
                    <p style='text-align:center;width: 80px'><b><span style='font-size:9.0pt;font-family:宋体'>(班级)</span></b></p>
                </td>
                <td width=179 colspan=5 rowspan=2 style='width:134.4pt;border:solid 1.0pt;border-top:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
                ...
                <td width=39 style='width:28.9pt;border:solid 1.0pt;border-top:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
                    <p style='text-align:center;text-autospace:ideograph-other'><span style='font-size:9.0pt;font-family:宋体'>Tel</span><span style='font-size:9.0pt;font-family:宋体'>：</span></p>
                </td>
                <td width=159 colspan=3 style='width:119.1pt;border:solid 1.0pt;border-top:solid 1.5pt;border-right:solid 1.5pt;padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:13.1pt'>
                    <p style='text-align:center;text-autospace:ideograph-other'><span style='font-size:9.0pt;font-family:宋体'>Q Q</span><span style='font-size:9.0pt;font-family:宋体'>：</span></p>
                </td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                ...
                <td width=462 colspan=4 style='width:200px;border-left:none;border-bottom:solid 1.0pt;border-right:none;
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                ...
                <td width=462 colspan="3" style='width:150px;border-left:none;border-bottom:solid 1.0pt;border-right:none; padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                ...
                <td colspan="3" style='width:28.9pt;
  border-bottom:solid 1.0pt;border-right:solid 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
                    <p style='text-align:center;'><span style='font-size:9.0pt;font-family:宋体'>
                        其他款式</span></p>
                </td>
                <td width=159 colspan=6 style='width:119.1pt;border-left:
  none;border-bottom:solid 1.0pt;border-right:solid 1.5pt;
...
padding:0cm 5.4pt 0cm 5.4pt;height:26.9pt'>
             ...
             <td width=462 colspan=16 style='width:346.35pt;border-left:
none;border-bottom:solid 1.0pt;border-right:solid 1.5pt;
padding:5.4pt 5.4pt 0cm 5.4pt;height:26.9pt'>
                 <p><span style='font-size:9.0pt;font-family:宋体'>
   <select name="province" id="province" onchange="getChildList('city',this.value)">
 ...
 <select name="city" id="city" onchange="getChildList('county',this.value)">
     <option value="">请选择地市</option>
 </select>
 <select name="county" id="county" check="require" msg="订单归属地不能为空">
 ...
 <input name="school" id="school" placeholder="输入学校等补充信息" class="input-text" style="width: 300px;"/>
            ...
            <%--   <tr style='height:8.7pt'>
                ...
                <td width=51 rowspan=2 style='width:55px; border-bottom:solid 1.0pt;border-right:solid 1.0pt;height:8.7pt'>
                    <p style='text-align:center;width: 80px'><span style='font-size:9.0pt;font-family:宋体'>男款</span></p>
                    <p style='text-align:center;width: 80px'><span style='font-size:5pt;font-family:宋体'>（通款）</span></p>
                </td>
                <td width=36 style='width:32pt;border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                    <p style='text-align:center;width: 80px'><span style='font-size:9.0pt;font-family:宋体'>*XS</span></p>
                </td>
   ...
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                ...
                <td width=36 style='width:32pt;border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                    <p style='text-align:center'><span style='font-size:9.0pt;font-family:宋体'>XXXXL</span></p>
                </td>
                <td width=51 rowspan=2 style='width:55px; border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                    <p style='text-align:center'><span style='font-size:9.0pt;font-family:宋体'>女款</span></p>
                </td>
                <td width=36 style='width:32pt; border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                    <p style='text-align:center'><span style='font-size:9.0pt;font-family:宋体'>S</span></p>
   ...
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                ...
                <td width=36 style='width:32pt;  border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:8.7pt'>
                    <p style='text-align:center'><span style='font-size:9.0pt;font-family:宋体'>XXL</span><span
                            style='font-size:7.5pt;font-family:宋体'>(</span><span style='font-size:7.5pt;
   font-family:宋体'>男<span>S)</span></span></p>
                </td>
   ...
   height:8.7pt'>
            ...
            <tr id="size" style='height:15.75pt'>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mxs" id="mxs" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="ms" id="ms" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mm" id="mm" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="ml" id="ml" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mxl" id="mxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mxxl" id="mxxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mxxxl" id="mxxxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="mxxxxl" id="mxxxxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="fs" id="fs" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="fm" id="fm" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="fl" id="fl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="fxl" id="fxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;height:15.75pt'>
                    <input type="number" name="fxxl" id="fxxl" check="positive" msg="数量只能为正数" />
                </td>
                <td width=36 style='width:32pt;border:solid 1.0pt;border-right:solid 1.5pt;height:15.75pt'>
   ...
   padding:5.4pt 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <p><span style='font-size:9.0pt;font-family:宋体'><input class="form-control" type="text" name="total_price" id="total_price" /></span></p>
                </td>
                <td width=112 colspan=4 rowspan=3 style='width:83.75pt;border:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <p style='text-align:center'><b><span style='font-size:9.0pt;font-family:宋体'>印制说明</span></b></p>
                </td>
                <td width=200 colspan=8 rowspan=3 style='width:200.1pt;
   border-bottom:solid 1.0pt;border-right:solid 1.5pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <textarea name="print_desc" id="print_desc"  check="require" msg="请说明印图技术" placeholder="请在此说明印图技术，如:2个单色图，或1个彩色图"  style="width:100%;height: 85px;"></textarea>
                </td>
            </tr>
            <tr style='height:15.7pt'>
                <td width=73 style='width:45px;border-left:solid 1.5pt;
   ...
   none;border-bottom:solid 1.0pt;border-right:solid 1.0pt;
   padding:5.4pt 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <p><span style='font-size:9.0pt;font-family:宋体'><input class="form-control" type="text" name="front_money" id="front_money" /></span></p>
                </td>
            </tr>
            <tr style='height:15.7pt'>
                <td width=73 style='width:45px;border-left:solid 1.5pt;
   ...
   padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
            ...
            <tr style='height:15.7pt'>
                ...
                <td width=165 colspan=4 style='width:123.5pt;border-bottom:solid 1.0pt;border-right:solid 1.0pt; padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <input data-date-format="yyyy-mm-dd" type="text" id="ship_time" name="ship_time" readonly="readonly" class="input-date form-control" check="require" msg="发货时间不能为空" >
                </td>
                <td width=112 colspan=4 rowspan=2 style='width:83.75pt;border:solid 1.0pt;
   padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <p style='text-align:center'><b><span style='font-size:9.0pt;font-family:宋体'>备注</span></b></p>
                </td>
                <td width=383 colspan=8 rowspan=2 style='width:287.1pt;border-bottom:solid 1.0pt;border-right:solid 1.5pt;padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
                    <textarea name="note" id="note" style="width:100%;height: 55px;"></textarea>
                </td>
            </tr>--%>
            <tr style='height:15.7pt'>
                <td width=73 style='width:45px;border-left:solid 1.5pt;
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:15.7pt'>
            ...
            <tr style='height:17.7pt'>
                <td width=733 colspan=17 style='width:549.45pt;border-left:
  solid 1.5pt;border-bottom:solid 1.0pt;border-right:
  solid 1.5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.7pt'>
                    <p style='text-align:center'><b><span style='font-size:9.0pt;font-family:宋体'>设计样稿（设计师：刘占峰）</span></b></p>
                </td>
            </tr>
            <tr style='height:26.95pt'>
                <td width=733 colspan=17 style='width:549.45pt;border-left:solid 1.5pt;border-bottom:solid 1.0pt;border-right:solid 1.5pt;padding:0cm 5.4pt 0cm 5.4pt;height:26.95pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                ...
                <td width=75 colspan=2 style='width:56.25pt;
  border-bottom:solid 1.0pt;border-right:solid 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <p style='text-align:center'><b><span
                            style='font-size:9.0pt;font-family:宋体;color:black'>收件人</span></b></p>
                </td>
                <td width=82 colspan=4 style='width:61.35pt;
  border-bottom:solid 1.0pt;border-right:solid 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <input class="form-control" type="text" id="ship_person" name="ship_person"  check="require" msg="收件人不能为空">
                </td>

                <td width=49 colspan=2 style='width:36.75pt;
  border-bottom:solid 1.0pt;border-right:solid 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <p style='text-align:center'><b><span
                            style='font-size:9.0pt;font-family:宋体;color:black'>联系方式</span></b></p>
                </td>
                <td width=110 colspan=6 style='width:82.35pt;border-left:none;border-bottom:solid 1.0pt;border-right:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <input class="form-control" type="text" id="ship_tel" name="ship_tel">
                </td>
            </tr>
            <tr style='height:27.7pt'>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                ...
                <td width=218 colspan=9 style='width:163.5pt;border-left:
  none;border-bottom:solid 1.5pt;border-right:none;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <select name="ship_pro" id="ship_pro" onchange="getChildList('ship_city',this.value)">
                        <option value="">请选择省分</option>
                        <option value='110000' >北京市</option><option value='120000' >天津市</option><option value='130000' >河北省</option><option value='140000' >山西省</option><option value='150000' >内蒙古自治区</option><option value='210000' >辽宁省</option><option value='220000' >吉林省</option><option value='230000' >黑龙江省</option><option value='310000' >上海市</option><option value='320000' >江苏省</option><option value='330000' >浙江省</option><option value='340000' >安徽省</option><option value='350000' >福建省</option><option value='360000' >江西省</option><option value='370000' >山东省</option><option value='410000' >河南省</option><option value='420000' >湖北省</option><option value='430000' >湖南省</option><option value='440000' >广东省</option><option value='450000' >广西壮族自治区</option><option value='460000' >海南省</option><option value='500000' >重庆市</option><option value='510000' >四川省</option><option value='520000' >贵州省</option><option value='530000' >云南省</option><option value='540000' >西藏自治区</option><option value='610000' >陕西省</option><option value='620000' >甘肃省</option><option value='630000' >青海省</option><option value='640000' >宁夏回族自治区</option><option value='650000' >新疆维吾尔自治区</option>	</select>
                    <select name="ship_city" id="ship_city" onchange="getChildList('ship_county',this.value)" >
                        <option value="">请选择地市</option>
                    </select>
                    <select name="ship_county" id="ship_county" check="require" msg="收件地址不能为空"  msg="收件地址若填写必须选择省市区（县）">
                        <option value="">请选择区县</option>
                    </select>
                </td>
                <td width=218 colspan=7 style='width:163.5pt;border-left:none;border-bottom:solid 1.5pt;border-right:solid 1.5pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:27.7pt'>
                    <input class="form-control" type="text" id="ship_addr" name="ship_addr">
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.user_info').on('mouseover',function() {
            var user_id = $(this).attr('accesskey');
            sendAjax("/user/user_json", 'user_id=' + user_id, function(data) {
                if (data.status) {
                    bl(data.data);
                }
            });
