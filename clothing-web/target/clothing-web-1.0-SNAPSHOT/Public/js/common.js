...
function conv_inputbox_item(id, name, title, data) {
    ...
    html += "<a class=\"del\" title=\"鍒犻櫎\"><i class=\"fa fa-times\"></i></a></nobr></span>";
    return html;
}
...
function contact_conv(val) {
    ...
    for (key in arr_temp) {
        if (arr_temp[key] != '') {
            ...
            //html +=  '<span data="' + arr_temp[key].split("|")[1] + '" onmousedown="return false"><nobr>' + arr_temp[key].split("|")[0] + '<a class=\"del\" title=\"鍒犻櫎\"><i class=\"fa fa-times\"></i></a></nobr></span>';
        }
    }
    return html;
}
...
$(document).ready(function() {
    ...
    $(".message-container .tbody a").click(function(){
